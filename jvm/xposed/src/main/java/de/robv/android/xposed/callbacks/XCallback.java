...
public abstract class XCallback implements Comparable<XCallback> {
    ...
    public static abstract class Param {
        ...
        // JVM change: extra changed from Bundle to Map
         ...
         * @see #getObjectExtra
         */
        public synchronized Map<String, Serializable> getExtra() {
            if (extra == null)
                extra = new HashMap<>();
            return extra;
        }
        ...
        public Object getObjectExtra(String key) {
            Serializable o = getExtra().get(key);
         ...
         * the Bundle returned by {@link #getExtra} instead.
         */
        public void setObjectExtra(String key, Object o) {
            getExtra().put(key, new SerializeWrapper(o));
        }
