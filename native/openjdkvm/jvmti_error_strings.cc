...
#define JVMTI_ERROR_STRING(name)                                                                                       \
    ...
    switch (err) {
        ...
        JVMTI_ERROR_STRING(JVMTI_ERROR_NONE)
        JVMTI_ERROR_STRING(JVMTI_ERROR_INVALID_THREAD)
        JVMTI_ERROR_STRING(JVMTI_ERROR_INVALID_THREAD_GROUP)
        JVMTI_ERROR_STRING(JVMTI_ERROR_INVALID_PRIORITY)
        JVMTI_ERROR_STRING(JVMTI_ERROR_THREAD_NOT_SUSPENDED)
        JVMTI_ERROR_STRING(JVMTI_ERROR_THREAD_SUSPENDED)
        JVMTI_ERROR_STRING(JVMTI_ERROR_THREAD_NOT_ALIVE)
        JVMTI_ERROR_STRING(JVMTI_ERROR_INVALID_OBJECT)
        JVMTI_ERROR_STRING(JVMTI_ERROR_INVALID_CLASS)
        JVMTI_ERROR_STRING(JVMTI_ERROR_CLASS_NOT_PREPARED)
