...
/*package*/ class WrappedCallbacks {
    ...
    public static class WrappedHookCallback implements IHookBridge.IMemberHookCallback {
        ...
        public WrappedHookCallback(@NotNull XC_MethodHook callback) {
            this.callback = callback;
        }

        @Override
        public void beforeHookedMember(@NotNull IHookBridge.IMemberHookParam param) throws Throwable {
        ...
        @Override
        public void afterHookedMember(@NotNull IHookBridge.IMemberHookParam param) throws Throwable {
