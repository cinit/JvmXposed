...
public interface IHookBridge {
    ...
    interface IMemberHookCallback {
        ...
        void beforeHookedMember(@NotNull IMemberHookParam param) throws Throwable;

        void afterHookedMember(@NotNull IMemberHookParam param) throws Throwable;
    ...
    interface IMemberHookParam {
         ...
         */
        void setThrowable(@NotNull Throwable throwable);
     ...
     */
    @NotNull
    MemberUnhookHandle hookMethod(@NotNull Member member, @NotNull IMemberHookCallback callback, int priority);
     ...
     */
    boolean deoptimize(@NotNull Member member);
     ...
     */
    @Nullable
    Object invokeOriginalMethod(@NotNull Method method, @Nullable Object thisObject, @NotNull Object[] args)
            throws NullPointerException, IllegalAccessException, IllegalArgumentException, InvocationTargetException;

    <T> void invokeOriginalConstructor(@NotNull Constructor<T> ctor, @NotNull T thisObject, @NotNull Object[] args)
            throws NullPointerException, IllegalAccessException, IllegalArgumentException, InvocationTargetException;
     ...
     */
    @NotNull
    <T> T newInstanceOrigin(@NotNull Constructor<T> constructor, @NotNull Object... args)
